...
public class Enemy extends Thread implements Serializable {
    ...
    public void run() {
        ...
        while (!interrupted) {
            ...
            // Random number is generated every 200ms and the enemy tries to move in that
            // direction
            try {
                Thread.sleep(200);
    ...
    // The move methods check if the move is valid and they update the map and enemy
    // location data
    // Player is hurt any time that they touch the enemy check this condition after
    // move
    public void moveUp() {
